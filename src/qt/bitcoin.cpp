...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("OrangeCoin");
    QApplication::setOrganizationDomain("OrangeCoin-noexist-domain.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("OrangeCoin-Qt-testnet");
    else
        QApplication::setApplicationName("OrangeCoin-Qt");
