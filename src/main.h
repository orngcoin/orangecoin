...
static const int64 MAX_MONEY = 50000000 * COIN; // OrangeCoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // OrangeCoin: 1440 blocks found a day. Priority cutoff is 100 OrangeCoin day / 250 bytes.
    }
