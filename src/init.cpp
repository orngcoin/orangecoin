...
void Shutdown()
{
    ...
    RenameThread("OrangeCoin-shutoff");
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 42382 or testnet: 62661)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 42391 or testnet: 62661)") + "\n" +
